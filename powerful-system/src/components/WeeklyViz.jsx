...
export default function WeeklyViz({
  weekTotalsByDay,
  weeklyTotal,
  dailyTarget,
}) {
  ...
  const max = Math.max(
    dailyTarget,
    ...(totalsArray.length ? totalsArray : [0]),
  );
  return (
    <div className="rounded-xl border border-zinc-800 p-4 bg-zinc-950 text-zinc-100">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-sm text-zinc-400">Total: {weeklyTotal} points</div>
      </div>
